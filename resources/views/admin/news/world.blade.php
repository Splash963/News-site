            ...
            <table class="table table-bordered">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <form action="{{ route('world.destroy', $newsItem->id) }}" style="display: inline;" method="POST">
                                @csrf
                                @method('DELETE')
                    ...
                    @else
                    <tr>
                        <td colspan="8" class="text-center">No World News found.</td>
                    </tr>
                    @endif
                </tbody>
            </table>
            <div style="display: flex; align-self: flex-start;">
                {{ $world->links('pagination::bootstrap-5') }}
            </div>
        </div>
    </body>

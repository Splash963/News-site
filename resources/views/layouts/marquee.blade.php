...
<body>
    <div class="row">
        <div class="col-md-12">
            ...
            <marquee class="marquee" behavior="" direction="left" class="fs-3">
                @foreach($recent_news as $news)
                <a href="{{route('news.show', $news->id)}}" class="link">
                <svg xmlns="http://www.w3.org/2000/svg" width="35" height="30" style="color: red;" class="me-2 ms-5" fill="currentColor" class="bi bi-skip-backward" viewBox="0 0 16 16">
